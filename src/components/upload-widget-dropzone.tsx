...
export function UploadWidgetDropzone() {
  ...
  const uploadCount = useUploads((store) => store.uploads.size);
  ...
  return (
    ...
    >
      <div
        ...
        className='cursor-pointer text-zinc-400 bg-black/20 p-5 rounded-lg border border-zinc-700 border-dashed h-32 flex flex-col justify-center items-center gap-1 hover:border-zinc-600 transition-colors data-[active=true]:bg-indigo-500/10 data-[active=true]:border-indigo-500'
        {...getRootProps()}
      >
